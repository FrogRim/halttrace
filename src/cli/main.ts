...
async function latest(options: CliOptions): Promise<void> {
...
async function explain(dumpPath: string | undefined, options: CliOptions): Promise<void> {
...
async function handoff(dumpPath: string | undefined, options: CliOptions): Promise<void> {
  const summary = await summaryFor(dumpPath, options);
  if (options.json) {
...
async function doctor(dumpPath: string | undefined, options: CliOptions): Promise<void> {
  const summary = await summaryFor(dumpPath, options);
...
async function summaryFor(dumpPath: string | undefined, options: CliOptions) {
...
function searchOptions(options: CliOptions) {
